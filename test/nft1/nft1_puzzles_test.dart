...
Future<void> main() async {
  ...
  test('Ownership Layer puzzle', () async {
    final puzzleForOwnershipLayerResult = puzzleForOwnershipLayer(
      innerPuzzle: puzzle,
      currentOwner: puzzleHash,
      transferProgram: Program.list([]),
    );
    print('_puzzleForOwnershipLayer');
    expect(puzzleForOwnershipLayerResult.hash().toHex(), spectedPuzzleForOwnershipLayerHash);
  ...
  test('Singleton Layer puzzle', () async {
    final solutionProgram1 = solutionForSingleton(
      ...
      lineageProof: LineageProof(
        parentCoinInfo: Puzzlehash(parentName),
  ...
  test('Transfer Layer puzzle', () async {
    final puzzleForTransferProgramR = puzzleForTransferProgram(
      launcherId: puzzleHash,
      percentage: 5,
      royaltyPuzzleHash: puzzleHash,
    );
    print('puzzleForTransferProgram');
    expect(puzzleForTransferProgramR.hash().toHex(), spectedPuzzleForTransferHash);
