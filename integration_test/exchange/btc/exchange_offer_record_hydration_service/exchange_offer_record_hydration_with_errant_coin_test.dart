...
Future<void> main() async {
  ...
  setUp(() async {
    ...
    final makerWalletVector = await WalletVector.fromPrivateKey(
    ...
    final takerWalletVector = await WalletVector.fromPrivateKey(
    ...
    final errantCoinSenderWalletVector =
        await WalletVector.fromPrivateKey(errantCoinSender.keychainSecret.masterPrivateKey, 1);
