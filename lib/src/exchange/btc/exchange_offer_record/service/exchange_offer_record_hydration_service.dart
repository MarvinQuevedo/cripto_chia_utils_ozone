...
class ExchangeOfferRecordHydrationService {
  ...
  Future<ExchangeOfferRecord> hydrateExchangeInitializationCoin(
    ...
    final exchangeCoins =
        await fullNode.getCoinsByMemo(Puzzlehash(initializationCoinId), includeSpentCoins: true);
    ...
    try {
      ...
      final wallectVector = WalletVector.fromPrivateKey(masterPrivateKey, derivationIndex);
