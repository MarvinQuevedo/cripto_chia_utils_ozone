...
class ExchangeOfferService {
  ...
  Future<ChiaBaseResponse> cancelExchangeOffer({
    ...
    final walletVector = WalletVector.fromPrivateKey(masterPrivateKey, derivationIndex);
  ...
  Future<ChiaBaseResponse> acceptMessageCoin({
    ...
    final walletVector = await WalletVector.fromPrivateKey(masterPrivateKey, derivationIndex);
