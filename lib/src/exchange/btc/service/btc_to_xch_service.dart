...
class BtcToXchService {
  ...
  SpendBundle createSweepSpendBundle({
    ...
    required PrivateKey requestorPrivateKey,
    required int clawbackDelaySeconds, required Bytes sweepPaymentHash, required JacobianPoint fulfillerPublicKey, required Bytes sweepPreimage, Puzzlehash? changePuzzlehash,
    int fee = 0,
    Bytes? originId,
  ...
  SpendBundle createSweepSpendBundleWithPk({
    ...
    required List<CoinPrototype> coinsInput,
    required PrivateKey requestorPrivateKey,
    required int clawbackDelaySeconds, required Bytes sweepPaymentHash, required PrivateKey fulfillerPrivateKey, Puzzlehash? changePuzzlehash,
    int fee = 0,
    Bytes? originId,
    List<AssertCoinAnnouncementCondition> coinAnnouncementsToAssert = const [],
    List<AssertPuzzleAnnouncementCondition> puzzleAnnouncementsToAssert = const [],
